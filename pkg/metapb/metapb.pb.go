...
type Region struct {
	...
	// the flag indicates whether the region needs to be encrypted in tikv.
	EncryptedRegion      uint64   `protobuf:"varint,9,opt,name=encrypted_region,json=encryptedRegion,proto3" json:"encrypted_region,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Region) GetEncryptedRegion() uint64 {
	if m != nil {
		return m.EncryptedRegion
	}
	return 0
}
...
var fileDescriptor_77b4d575d5a68dda = []byte{
	...
	,
}
...
func (m *Region) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EncryptedRegion != 0 {
		i = encodeVarintMetapb(dAtA, i, uint64(m.EncryptedRegion))
		i--
		dAtA[i] = 0x48
	}
...
func (m *Region) Size() (n int) {
	...
	if m.EncryptedRegion != 0 {
		n += 1 + sovMetapb(uint64(m.EncryptedRegion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Region) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncryptedRegion", wireType)
			}
			m.EncryptedRegion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EncryptedRegion |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
